          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-2xl font-bold text-foreground">Arjun Sharma</span>
              </div>

              <p className="text-muted-foreground leading-relaxed text-sm">
                Full Stack Developer passionate about building modern web apps, real-time platforms, and elegant user experiences.
              </p>
              ...
              <div className="space-y-4 text-sm text-muted-foreground">
                <div className="flex items-start space-x-3 group">
                  ...
                  <a 
                    href="mailto:arjunsharma3132@gmail.com"
                    className="hover:text-primary transition-colors duration-300 break-all"
                  >
                    arjunsharma3132@gmail.com
                  </a>
                </div>
                <div className="flex items-center space-x-3">
                  <Phone className="w-4 h-4 text-primary flex-shrink-0" />
                  <a 
                    href="tel:+917814405105"
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Arjun Sharma. All rights reserved.
            </div>
